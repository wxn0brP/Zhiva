...
- **One-Time Global Install**: Install Zhiva once system-wide. Apps deploy via `git clone` with optional lightweight post-install scripts.
...
| **Native TypeScript** | Yes (via Bun) | No | No (backend is Rust) |

## Platform Support

- **Windows**: Full support
- **Linux**: Full support 
- **macOS**: Experimental support (actively improving)
...
Zhiva Project. Open source under the MIT License.